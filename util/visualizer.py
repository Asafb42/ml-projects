...
class Visualizer():
    ...
    def __init__(self, opt):
        ...
        self.use_tensorboard = opt.visualization == 'tensorboard'
        self.use_visdom = opt.visualization == 'visdom'
    ...
    def plot_current_losses(self, epoch, counter_ratio, losses):
        """display the current losses on tensorboard or visdom display: dictionary of error labels and values
    ...
    def print_validation(self, epoch, losses):
        """print validation losses on console; also save the losses to the disk
        ...
        for k, v in losses.items():
            ...
            # write the validation losses to tensorboard.
            if self.use_tensorboard:
