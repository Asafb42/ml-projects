...
class AttentionCycleGANModel(BaseModel):
    """
    This class implements the Attention-CycleGAN model, for learning image-to-image translation without paired data.
    ...
    The model required a pretrained network from which it computes the attention maps as an auxiliary data for the reconstruction.
    """
    @staticmethod
    def modify_commandline_options(parser, is_train=True):
        ...
        if is_train:
            ...
            parser.add_argument('--attention_model_path', type=str, default=None, help='The path to the pretrained attention network to load')
    ...
    def __init__(self, opt):
        ...
        self.netG_A = networks.define_G(opt.input_nc + self.attention_nc, opt.output_nc, opt.ngf, opt.netG, opt.norm,
                                        not opt.no_dropout, opt.init_type, opt.init_gain, self.gpu_ids)
        self.netG_B = networks.define_G(opt.output_nc + self.attention_nc, opt.input_nc, opt.ngf, opt.netG, opt.norm,
                                        not opt.no_dropout, opt.init_type, opt.init_gain, self.gpu_ids)
    ...
    def set_input(self, input):
        ...
        _, self.att_A = self.attention_net(self.real_A)
